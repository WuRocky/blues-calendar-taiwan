...
assert.match(organizerPreviewApi, /lineChannelAccessToken: config\.lineTestChannelAccessToken/)
assert.match(organizerPreviewApi, /lineOrganizerGroupId: config\.lineTestGroupId/)
